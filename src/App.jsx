...
// NEW IMPORTS FOR DEALER ACCOUNT/TEAM PAGES
import BusinessProfile from './pages/dealer/BusinessProfile.jsx'; // Renamed from AccountDetails.jsx
import FinancialDetails from './pages/dealer/FinancialDetails.jsx'; // NEW
import MyTeam from './pages/dealer/MyTeam.jsx'; // NEW
...
  DEALER_CUSTOMERS: '/dealer/customers',
  ...
  DEALER_BUSINESS_PROFILE: '/dealer/profile', // Replaces old DEALER_ACCOUNT
...
          {/* UPDATED/NEW DEALER ACCOUNT/FINANCE/TEAM ROUTES */}
          <Route path="profile" element={<BusinessProfile />} /> {/* Renamed from "account" */}
          <Route path="finance" element={<FinancialDetails />} /> {/* NEW */}
          <Route path="team" element={<MyTeam />} /> {/* NEW */}
