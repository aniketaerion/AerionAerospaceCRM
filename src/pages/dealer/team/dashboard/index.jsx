...
import WidgetCard from '@/components/common/WidgetCard'; // Assuming this path is correct for your WidgetCard component
...
const MyTeam = () => {
    ...
    useEffect(() => {
        ...
        const fetchTeamData = async () => {
            setLoading(true);
            try {
                const response = await fetch('/api/dealer/team'); // Replace with your actual API endpoint
                if (!response.ok) {
