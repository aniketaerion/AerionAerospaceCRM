...
const mockTimeline = [
  {
    ...
    date: '2025-06-01',
    time: '14:30',
    detail: 'Purchased DJI Agras 120 • ₹14.8L • Invoice #INV-08413',
    by: 'Sales Team',
    tags: ['Repeat Buyer']
  },
  {
    ...
    date: '2025-05-20',
    time: '11:00',
    detail: 'Follow-up call to discuss accessories package',
    by: 'Sales Exec 2',
    tags: ['Follow-Up']
  },
  {
    ...
    date: '2025-05-15',
    time: '17:45',
    detail: 'Sent AMC pricing & renewal reminder',
  ...
  },
  {
    ...
    date: '2025-05-10',
    time: '09:10',
    detail: 'Complaint raised for GPS issue - Resolved same day',
    by: 'Service Agent',
    tags: ['Resolved']
  },
  {
    ...
    date: '2025-01-10',
    time: '00:00',
    detail: '🎉 Birthday message sent via WhatsApp',
    by: 'Automation Engine',
    tags: ['Auto']
  }
];
